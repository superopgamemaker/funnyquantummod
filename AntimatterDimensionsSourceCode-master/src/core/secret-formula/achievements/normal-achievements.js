...
export const normalAchievements = [
  ...
  },
  {
    ...
    get reward() { return `8th Antimatter Dimensions are ${formatPercents(0.1225)} stronger.`; },
    effect: 1.1225
  },
  {
    id: 24,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
    get reward() { return `1st Antimatter Dimensions are ${formatPercents(0.1225)} stronger.`; },
    effect: 1.1225
  },
  {
    id: 31,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `1st Antimatter Dimensions are ${formatPercents(0.06125)} stronger.`; },
    effect: 1.06125
  },
  {
    id: 32,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Dimensions 1-7 are ${formatPercents(0.0245)} stronger.`; },
    effect: 1.0245
  },
  {
    id: 35,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Multiply starting tick speed by ${format(1.0245, 2, 2)}.`; },
    effect: 1 / 1.0245
  },
  {
    id: 37,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Multiply starting tickspeed by ${formatX(1.0245, 0, 2)}.`; },
    effect: 0.9755
  },
  {
    id: 46,
  ...
  },
  {
    ...
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER, GAME_EVENT.REALITY_UPGRADE_TEN_BOUGHT],
    get reward() { return `All Dimensions are ${formatPercents(0.1225)} stronger.`; },
    effect: 1.1225
  },
  {
    id: 51,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Increase the multiplier for buying ${formatInt(10)} Antimatter Dimensions by +${formatPercents(0.01225)}.`;
    },
    effect: 1.01225
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Antimatter Dimensions 1-4 are ${formatPercents(0.35)} stronger.`; },
    effect: 1.35
  },
  {
    id: 65,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `1st Antimatter Dimensions are ${formatPercents(0.6125)} stronger.`; },
    effect: 1.6125
  },
  {
    id: 71,
    ...
    checkRequirement: () =>
      ...
      player.galaxies === 0,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `1st Antimatter Dimensions are ${formatInt(4)} times stronger.`; },
    effect: 4
  },
  {
    id: 72,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `All Antimatter Dimensions are ${formatPercents(0.1225)} stronger.`; },
    effect: 1.1225
  },
  {
    id: 73,
    ...
    effect: () => Currency.antimatter.value.pow(0.0000245).plus(1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 74,
    ...
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER],
    get reward() { return `All Antimatter Dimensions are ${formatPercents(0.5)} stronger, but only in challenges.`; },
    effect: 1.5,
  ...
  },
  {
    ...
    effect: () => Math.max(Math.pow(Time.totalTimePlayed.totalDays / 2, 0.06125), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    get reward() { return `Tickspeed is just over ${formatPercents(0.05)} faster per Antimatter Galaxy (^1.2 if you have quantumed).`; },
    effect: () => DC.D0_95.pow(player.galaxies ** 1.2),
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(5.5)} multiplier to Infinity Points.`; },
    effect: 5.5
  },
  {
    id: 86,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `All Galaxies are ${formatPercents(0.01225)} stronger.`; },
    effect: 1.01225
  },
  {
    id: 87,
    ...
    get reward() {
      ...
      give ${formatX(870)} more Infinities.`;
    },
    effect: 870,
  ...
  },
  {
    ...
    effect: () => Math.max((5 - Time.thisInfinity.totalSeconds) * 60, 1) ** 1.225,
    effectCondition: () => Time.thisInfinity.totalSeconds < 5,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    ...
    effect: () => Math.max((1 - Time.thisInfinity.totalMinutes) * 100, 1) ** 1.225,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "2.4x Infinity Power gain.",
    effect: 2.4
  },
  {
    id: 95,
  ...
  },
  {
    ...
    effect: () => Tickspeed.perSecond.pow(0.000006125),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 106,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() { return `Gain ${formatX(2.4)} more Eternities.`; },
    effect: 2.4,
  },
  {
    id: 114,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.DIMBOOST_AFTER,
    get reward() {
      return `The multiplier from Dimension Boosts to Antimatter Dimensions is ${formatPercents(0.01225)} higher.`;
    },
    effect: 1.01225
  },
  {
  ...
  },
  {
    ...
    effect() {
      ...
      return DC.D2.pow(Math.log(thisInfinity) * Math.min(Math.pow(thisInfinity, 0.11), 612.5));
    },
    cap: () => Effarig.eternityCap,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  ...
  },
  {
    ...
    effect: () => 1.22 * Math.max(Math.pow(player.galaxies, 0.049), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 133,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `You gain Replicanti ${formatInt(2.4)} times faster under ${format(replicantiCap(), 1)} Replicanti.`;
    }
  },
  {
    id: 135,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Gain ${formatX(.42)} Dilated Time and Time Theorems while Dilated.`; },
    effect: () => (player.dilation.active ? 2.4 : 1),
  },
  {
    id: 138,
  ...
  },
  {
    ...
    get reward() {
      return `${formatX(5.5)} Infinity Point gain, and increase the multiplier for buying ${formatInt(10)}
      Antimatter Dimensions by +${format(0.1225, 0, 1)}.`;
    },
    effects: {
      ipGain: 5,
      buyTenMult: 0.1225
  ...
  },
  {
    ...
    get reward() { return `Dimension Boosts are ${formatPercents(0.6125)} stronger.`; },
    effect: 1.6125,
  },
  {
    id: 143,
  ...
  },
  {
    ...
    get reward() { return `Black Hole intervals are ${formatPercents(0.12)} shorter.`; },
    effect: 0.88
  },
  {
    id: 146,
    ...
    get reward() { return `+${formatPercents(0.01225)} Glyph rarity.`; },
    effect: 1.225
  },
  {
    id: 147,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Black Hole durations are ${formatPercents(0.1225)} longer.`; },
    effect: 1.1225
  },
  {
    id: 156,
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() { return `Gain ${formatX(3, 0, 1)} generated Time Theorems, and a free coupon to McDonalds™️.`; },
    effect: 3
  },
  {
    id: 157,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BLACK_HOLE_UPGRADE_BOUGHT,
    get reward() { return `Black Hole power increased by ${formatPercents(0.1225)}.`; },
    effect: 1.1225
  },
  {
    id: 161,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Gain ×${formatInt(2550)} more Infinities.`; },
    effect: 2550
  },
  {
    id: 165,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Get ${formatPercents(0.1225)} more memories.`; },
    effect: 1.1225
  },
  {
    id: 171,
    ...
    checkEvent: GAME_EVENT.GLYPHS_CHANGED,
    get reward() { return `Glyph sacrifice is ${formatX(2.4)} stronger.`; },
    effect: 2.4,
  },
  {
    id: 172,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_AFTER,
    get reward() {
      return `Synergism can go above ${formatPercents(1)} and Momentum increases ${formatX(13)} faster.`;
    },
    effect: 13,
  },
  {
