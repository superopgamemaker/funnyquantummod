...
export function antimatterDimensionCommonMultiplier() {
  ...
  multiplier = multiplier.times(player.records.realTimePlayed * 0.001 + 1)
...
function applyNDPowers(mult, tier) {
  ...
  multiplier = multiplier.pow(glyphPowMultiplier * glyphEffarigPowMultiplier * Ra.momentumValue * 1.0302);
